...
<template>
  <div v-if="!showTags" ref="containerDom" class="tags-view">
    ...
    <div ref="scrollbarDom" class="scroll-container" :class="tagsStyle === 'chrome' && 'chrome-scroll-container'"
      ...
      <div ref="tabDom" class="tab select-none" :style="getTabStyle">
        <div v-for="(item, index) in multiTags" :ref="'dynamic' + index" :key="index" :class="[
          ...
          <template v-if="tagsStyle !== 'chrome'">
            ...
            <span v-if="tagsStyle !== 'card'" :ref="'schedule' + index" :class="[scheduleIsActive(item)]" />
          </template>
          <div v-else class="chrome-tab">
            <span v-if="index !== 0 && index !== activeIndex"
